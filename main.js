...
function onSubmitProduct(event) {
  ...
  document.getElementById('client-form').addEventListener('submit', onSubmitClient);
  document.getElementById('product-form').addEventListener('submit', onSubmitProduct);
